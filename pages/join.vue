<template>
  <b-container fluid>
    ...
    with a Curtin Student Guild club membership voucher. Interested in joining? You can join in one of two ways: <br><br>
    Note: If you’re using a club membership voucher then you must follow the In-Person method.
    ...
    To get started, head over <a href="https://comssa.tidyhq.com/public/membership_levels/">here</a>.
